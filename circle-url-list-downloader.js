 ...
 * Open https://webcatalog.circle.ms/User/Favorites and enter this script in DevTools's console 
...
const arrFavoriteList = Array.from(document.querySelectorAll(strQueryFavoriteList))
                            .filter(ele => ele.href.startsWith('https://webcatalog.circle.ms/Circle/'))
                            .map(ele => ele.href);
